import{j as e,r as c,i as Ye,g as ye,a as W}from"./app-BaJPuWjO.js";import{a as L}from"./mapbox-gl-_Pp-i5bo.js";import{h as Ke,i as et,j as tt,g as at}from"./index-Dej2M5ze.js";import"./iconBase-BlJoYU-T.js";const rt=({isLoading:v=!1,size:S="medium",message:E="Collecting garbage..."})=>{if(!v)return null;const b={small:"w-16 h-16",medium:"w-24 h-24",large:"w-32 h-32",xlarge:"w-48 h-48"},T={small:"text-xs",medium:"text-sm",large:"text-base",xlarge:"text-lg"};return e.jsxs("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50",children:[e.jsxs("div",{className:"bg-white rounded-2xl p-8 shadow-2xl flex flex-col items-center",children:[e.jsxs("div",{className:`relative ${b[S]} mb-4`,children:[e.jsx("div",{className:"absolute bottom-0 left-0 right-0 h-2 bg-gray-600 rounded-full"}),e.jsx("div",{className:"absolute bottom-3 left-4 w-3 h-4 bg-gray-400 rounded-sm",children:e.jsx("div",{className:"absolute -top-1 left-0.5 w-2 h-1 bg-gray-500 rounded-sm"})}),e.jsx("div",{className:"absolute bottom-3 left-8 w-3 h-5 bg-gray-400 rounded-sm",children:e.jsx("div",{className:"absolute -top-1 left-0.5 w-2 h-1 bg-gray-500 rounded-sm"})}),e.jsx("div",{className:"absolute bottom-3 left-12 w-3 h-4 bg-gray-400 rounded-sm",children:e.jsx("div",{className:"absolute -top-1 left-0.5 w-2 h-1 bg-gray-500 rounded-sm"})}),e.jsx("div",{className:"absolute bottom-2 left-0 animate-collect-garbage",children:e.jsxs("div",{className:"relative",children:[e.jsxs("div",{className:"w-6 h-4 bg-green-600 rounded-t-sm",children:[e.jsx("div",{className:"absolute top-0.5 left-1 w-3 h-1.5 bg-blue-300 rounded-sm"}),e.jsx("div",{className:"absolute bottom-0 left-1 w-1 h-0.5 bg-yellow-300 rounded-full"})]}),e.jsx("div",{className:"absolute left-6 top-1 w-8 h-3 bg-green-700 rounded-sm",children:e.jsx("div",{className:"absolute top-0.5 left-1 w-6 h-2 bg-gray-800 rounded",children:e.jsx("div",{className:"absolute -top-1 left-0 right-0 h-1 bg-gray-700 rounded-t animate-garbage-fill"})})}),e.jsx("div",{className:"absolute -bottom-1 left-1 w-2 h-2 bg-black rounded-full",children:e.jsx("div",{className:"absolute inset-0.5 w-1 h-1 bg-gray-600 rounded-full"})}),e.jsx("div",{className:"absolute -bottom-1 left-5 w-2 h-2 bg-black rounded-full",children:e.jsx("div",{className:"absolute inset-0.5 w-1 h-1 bg-gray-600 rounded-full"})}),e.jsx("div",{className:"absolute -bottom-1 left-11 w-2 h-2 bg-black rounded-full",children:e.jsx("div",{className:"absolute inset-0.5 w-1 h-1 bg-gray-600 rounded-full"})})]})}),e.jsx("div",{className:"absolute bottom-3 left-16 w-4 h-1 bg-gray-400 rounded-full animate-dust-cloud opacity-0"})]}),e.jsx("div",{className:`text-center ${T[S]} text-gray-700 font-semibold`,children:E}),e.jsxs("div",{className:"flex space-x-1 mt-2",children:[e.jsx("div",{className:"w-2 h-2 bg-green-500 rounded-full animate-bounce",style:{animationDelay:"0ms"}}),e.jsx("div",{className:"w-2 h-2 bg-green-500 rounded-full animate-bounce",style:{animationDelay:"150ms"}}),e.jsx("div",{className:"w-2 h-2 bg-green-500 rounded-full animate-bounce",style:{animationDelay:"300ms"}})]})]}),e.jsx("style",{jsx:!0,children:`
      ...
      `})]})},J={Alegria:"#FF5733","Barangay 1":"#33FF57","Barangay 2":"#3357FF","Barangay 3":"#F033FF","Barangay 4":"#FF33F0","Barangay 5":"#33FFF0","Bayugan 2":"#8A2BE2","Bitan-agan":"#A52A2A",Borbon:"#DEB887",Buenasuerte:"#5F9EA0",Caimpugan:"#7FFF00","Das-agan":"#D2691E",Ebro:"#FF7F50",Hubang:"#6495ED",Karaus:"#DC143C",Ladgadan:"#00FFFF",Lapinigan:"#00008B",Lucac:"#008B8B",Mate:"#B8860B","New Visayas":"#006400",Ormaca:"#8B008B",Pasta:"#556B2F","Pisa-an":"#FF8C00",Rizal:"#9932CC","San Isidro":"#8FBC8F","Santa Ana":"#483D8B",Tagapua:"#2F4F4F","San Francisco":"#FFE659",_default:"#4F262A"},gt=({mapboxKey:v,barangayId:S,scheduleId:E,isFullscreen:b=!1})=>{const T=c.useRef(null),i=c.useRef(null),[_,U]=c.useState(!1),[h,A]=c.useState(!1),[C,ie]=c.useState(null),[f,je]=c.useState(null),[le,Se]=c.useState(null),[w,ce]=c.useState([]),[Q,$e]=c.useState([]),[st,ot]=c.useState(!0),[nt,de]=c.useState(!0),[P,Y]=c.useState("connecting"),[ue,I]=c.useState(null),[H,Ne]=c.useState(!1),[ke,me]=c.useState(!1),[Fe,Me]=c.useState("Loading map data..."),O=(a="Loading map data...")=>{Me(a),me(!0)},R=()=>{me(!1)},[N,q]=c.useState([]),[d,G]=c.useState(null),[k,Le]=c.useState([]),[F,Ee]=c.useState(null),[y,Re]=c.useState(null),[o,Te]=c.useState(!1),[D,ge]=c.useState(!0),[K,pe]=c.useState(!1),[fe,ee]=c.useState(null),[j,it]=c.useState(!0),B=c.useRef(null),te=c.useRef(null),[Ce,Be]=c.useState(Date.now()),ze=()=>Date.now()-Ce<3e4,[he,Ae]=c.useState({width:typeof window<"u"?window.innerWidth:1200,height:typeof window<"u"?window.innerHeight:800});c.useEffect(()=>{if(!i.current)return;const a=["mousedown","touchstart","wheel","movestart","dragstart"],r=()=>{Be(Date.now())};return a.forEach(t=>{i.current.on(t,r)}),()=>{a.forEach(t=>{i.current&&i.current.off(t,r)})}},[i.current]),c.useEffect(()=>{const a=()=>{const r=window.innerWidth<768;Te(r),Ae({width:window.innerWidth,height:window.innerHeight}),r&&ge(!1)};return a(),window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]),c.useEffect(()=>{v&&(console.log("Setting Mapbox access token"),L.accessToken=v)},[v]),c.useEffect(()=>{const a=()=>{T.current?(console.log("Map container is ready in DOM"),Ne(!0)):(console.log("Waiting for map container..."),setTimeout(a,100))};a()},[]),c.useEffect(()=>{if((()=>{const l=document.querySelector('link[href*="mapbox-gl.css"]');return l&&l.sheet?(console.log("Mapbox CSS already loaded"),U(!0),!0):!1})())return;const r=document.createElement("link");r.href="https://api.mapbox.com/mapbox-gl-js/v3.0.0/mapbox-gl.css",r.rel="stylesheet",r.type="text/css";let t;const n=()=>{clearTimeout(t),console.log("Mapbox CSS loaded successfully"),U(!0)},s=()=>{clearTimeout(t),console.warn("Mapbox CSS failed to load, continuing anyway"),U(!0)};r.onload=n,r.onerror=s,document.head.appendChild(r),t=setTimeout(()=>{console.warn("Mapbox CSS load timeout, continuing anyway"),U(!0)},5e3)},[]);const ae=a=>{if(a<60)return`${a} min`;{const r=Math.floor(a/60),t=a%60;return t===0?`${r}h`:`${r}h ${t}min`}},X=(a,r,t,n)=>{const l=(t-a)*Math.PI/180,m=(n-r)*Math.PI/180,p=Math.sin(l/2)*Math.sin(l/2)+Math.cos(a*Math.PI/180)*Math.cos(t*Math.PI/180)*Math.sin(m/2)*Math.sin(m/2);return 6371*(2*Math.atan2(Math.sqrt(p),Math.sqrt(1-p)))},De=(a,r)=>{if(!a||r.length===0)return r;const t=[...r],n=[],s=t.map(g=>{const u=X(parseFloat(a.latitude),parseFloat(a.longitude),parseFloat(g.latitude),parseFloat(g.longitude));return{...g,distance:u,coordinates:[parseFloat(g.longitude),parseFloat(g.latitude)]}});s.sort((g,u)=>g.distance-u.distance);const l=s[0];n.push(l);const m=s.slice(1);let p=l;for(;m.length>0;){let g=-1,u=1/0;for(let x=0;x<m.length;x++){const $=X(parseFloat(p.latitude),parseFloat(p.longitude),parseFloat(m[x].latitude),parseFloat(m[x].longitude));$<u&&(u=$,g=x)}g!==-1&&(p=m[g],n.push(p),m.splice(g,1))}return n},xe=async(a,r,t=!1)=>{if(!(!v||a.length<1)){pe(!0),O("Calculating optimal route..."),ee(null);try{const n=a.filter(u=>u.latitude&&u.longitude&&!isNaN(parseFloat(u.latitude))&&!isNaN(parseFloat(u.longitude)));if(n.length<1){console.warn("No valid sites with coordinates found"),ee("No valid sites with coordinates found");return}const s=r?De(r,n.filter(u=>u.type!=="station")):n;if(Le(s),s.length>0&&Ee(s[0]),t&&f&&s.length>0){const u=[`${f[0].toFixed(6)},${f[1].toFixed(6)}`,...s.map(x=>`${parseFloat(x.longitude).toFixed(6)},${parseFloat(x.latitude).toFixed(6)}`)];try{const x=await fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${u.join(";")}?access_token=${v}&geometries=geojson&overview=full&steps=true&alternatives=false&continue_straight=false&roundabout_exits=true`);if(x.ok){const $=await x.json();if($.routes&&$.routes.length>0){const z=$.routes[0],Z=Math.round(z.duration/60),ne=(z.distance/1e3).toFixed(1);q(z.geometry.coordinates),G({duration:Z,formattedDuration:ae(Z),distance:ne,targetSite:s[0].site_name,isRealTime:!0,totalStops:s.length}),console.log(`Complete sequential route calculated from driver through ${s.length} sites`),i.current&&h&&M();return}}}catch(x){console.error("Error calculating driver sequential route:",x)}}let l=[];r?l=[`${parseFloat(r.longitude).toFixed(6)},${parseFloat(r.latitude).toFixed(6)}`,...s.map(u=>`${parseFloat(u.longitude).toFixed(6)},${parseFloat(u.latitude).toFixed(6)}`)]:l=s.map(u=>`${parseFloat(u.longitude).toFixed(6)},${parseFloat(u.latitude).toFixed(6)}`);const m=l.length>2,p=await fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${l.join(";")}?access_token=${v}&geometries=geojson&overview=full&steps=true&alternatives=false&continue_straight=false`+(m?"&roundabout_exits=true":""));if(!p.ok)throw new Error(`HTTP error! status: ${p.status}`);const g=await p.json();if(g.routes&&g.routes.length>0){const u=g.routes[0];if(u.geometry&&u.geometry.coordinates){const x=Math.round(u.duration/60),$=(u.distance/1e3).toFixed(1);q(u.geometry.coordinates),G({duration:x,formattedDuration:ae(x),distance:$,rawData:u,totalStops:s.length,isRealTime:!1}),console.log(`Station route calculated: ${x}min, ${$}km`),i.current&&h&&M()}else throw new Error("Invalid route geometry received")}else throw new Error(g.message||"No routes found")}catch(n){console.error("Error calculating route:",n),ee(`Route calculation failed: ${n.message}`);const s=a.filter(l=>l.latitude&&l.longitude&&!isNaN(parseFloat(l.latitude))&&!isNaN(parseFloat(l.longitude)));if(s.length>0){const l=s.map(m=>[parseFloat(m.longitude),parseFloat(m.latitude)]);q(l),G({duration:Math.round(be(l)*2),formattedDuration:"Estimated",distance:be(l).toFixed(1),isFallback:!0,totalStops:s.length,isRealTime:!1}),i.current&&h&&M()}}finally{pe(!1),R()}}},be=a=>{let r=0;for(let t=1;t<a.length;t++){const[n,s]=a[t-1],[l,m]=a[t];r+=X(s,n,m,l)}return r},V=async()=>{if(!(!j||!f||!k.length)){if(te.current){const[a,r]=te.current,[t,n]=f;if(X(r,a,n,t)*1e3<50)return}te.current=f,console.log("Updating complete sequential route from driver location through all sites");try{const a=[`${f[0].toFixed(6)},${f[1].toFixed(6)}`,...k.map(t=>`${parseFloat(t.longitude).toFixed(6)},${parseFloat(t.latitude).toFixed(6)}`)],r=await fetch(`https://api.mapbox.com/directions/v5/mapbox/driving/${a.join(";")}?access_token=${v}&geometries=geojson&overview=full&steps=true&alternatives=false&continue_straight=false&roundabout_exits=true`);if(r.ok){const t=await r.json();if(t.routes&&t.routes.length>0){const n=t.routes[0],s=Math.round(n.duration/60),l=(n.distance/1e3).toFixed(1);q(n.geometry.coordinates),G(m=>({...m,duration:s,formattedDuration:ae(s),distance:l,targetSite:k[0].site_name,isRealTime:!0,totalStops:k.length,lastUpdated:new Date().toLocaleTimeString()})),console.log(`Sequential route updated: Driver through ${k.length} sites (${l}km, ${s}min)`),i.current&&h&&M()}}}catch(a){console.error("Error updating real-time route:",a)}}},_e=()=>{B.current&&clearInterval(B.current),B.current=setInterval(()=>{j&&f&&k.length>0&&V()},2e3),console.log("Started real-time route updates")},Ue=()=>{B.current&&(clearInterval(B.current),B.current=null),console.log("Stopped real-time route updates")},M=()=>{if(!(!i.current||N.length===0)){if(!i.current.isStyleLoaded()){i.current.once("styledata",()=>{setTimeout(M,100)});return}["route","route-glow","route-direction","route-start","route-end","route-waypoints","driver-route","driver-route-glow"].forEach(a=>{i.current.getLayer(a)&&i.current.removeLayer(a)}),i.current.getSource("route")&&i.current.removeSource("route"),i.current.getSource("driver-route")&&i.current.removeSource("driver-route"),["route-start-marker","route-end-marker","route-waypoints-marker"].forEach(a=>{i.current.getSource(a)&&i.current.removeSource(a)});try{const a=d!=null&&d.isRealTime?"driver-route":"route",r=d!=null&&d.isRealTime?"driver-route":"route",t=d!=null&&d.isRealTime?"driver-route-glow":"route-glow";i.current.addSource(a,{type:"geojson",data:{type:"Feature",properties:{},geometry:{type:"LineString",coordinates:N}}});const n=(C==null?void 0:C.barangay_name)||"San Francisco",s=d!=null&&d.isRealTime?"#10B981":J[n]||J._default,l=o?6:5,m=o?14:12;i.current.addLayer({id:t,type:"line",source:a,layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":s,"line-width":m,"line-opacity":d!=null&&d.isRealTime?.4:.3,"line-blur":10}}),i.current.addLayer({id:r,type:"line",source:a,layout:{"line-join":"round","line-cap":"round"},paint:{"line-color":s,"line-width":l,"line-opacity":.9,"line-dasharray":d!=null&&d.isRealTime?[2,1]:[1,0]}}),i.current.addLayer({id:"route-direction",type:"symbol",source:a,layout:{"symbol-placement":"line","text-field":"▶","text-size":o?14:12,"symbol-spacing":100},paint:{"text-color":s}});const p=[];y&&y.latitude&&y.longitude&&!(d!=null&&d.isRealTime)&&p.push({coordinates:[parseFloat(y.longitude),parseFloat(y.latitude)],type:"station",sequence:0}),k.forEach((g,u)=>{g.latitude&&g.longitude&&p.push({coordinates:[parseFloat(g.longitude),parseFloat(g.latitude)],type:"site",sequence:u+1,isTarget:(d==null?void 0:d.isRealTime)&&u===0})}),p.length>0&&(i.current.addSource("route-waypoints-marker",{type:"geojson",data:{type:"FeatureCollection",features:p.map((g,u)=>({type:"Feature",geometry:{type:"Point",coordinates:g.coordinates},properties:{description:g.type==="station"?"Station":g.isTarget?`Target: ${g.sequence}`:`Site ${g.sequence}`,type:g.type,sequence:g.sequence,isTarget:g.isTarget}}))}}),i.current.addLayer({id:"route-waypoints",type:"circle",source:"route-waypoints-marker",paint:{"circle-radius":["case",["==",["get","type"],"station"],o?10:8,["==",["get","isTarget"],!0],o?12:10,o?8:6],"circle-color":["case",["==",["get","type"],"station"],"#dc2626",["==",["get","isTarget"],!0],"#10B981","#3b82f6"],"circle-stroke-width":2,"circle-stroke-color":"#ffffff"}})),!(d!=null&&d.isRealTime)&&N.length>=2&&(i.current.addSource("route-start-marker",{type:"geojson",data:{type:"Feature",geometry:{type:"Point",coordinates:N[0]},properties:{description:"Start"}}}),i.current.addSource("route-end-marker",{type:"geojson",data:{type:"Feature",geometry:{type:"Point",coordinates:N[N.length-1]},properties:{description:"End"}}}),i.current.addLayer({id:"route-start",type:"circle",source:"route-start-marker",paint:{"circle-radius":o?8:6,"circle-color":"#22c55e","circle-stroke-width":2,"circle-stroke-color":"#ffffff"}}),i.current.addLayer({id:"route-end",type:"circle",source:"route-end-marker",paint:{"circle-radius":o?8:6,"circle-color":"#ef4444","circle-stroke-width":2,"circle-stroke-color":"#ffffff"}})),setTimeout(()=>{ve()},200)}catch(a){console.error("Error adding route layer:",a),setTimeout(()=>{M()},500)}}},ve=()=>{if(!i.current||N.length===0||w.length===0)return;const a=new L.LngLatBounds;N.forEach(t=>{a.extend(t)}),y&&a.extend([parseFloat(y.longitude),parseFloat(y.latitude)]),w.forEach(t=>{t.longitude&&t.latitude&&a.extend([parseFloat(t.longitude),parseFloat(t.latitude)])}),f&&a.extend(f);const r=o?40:80;try{i.current.fitBounds(a,{padding:r,duration:1500,essential:!0,maxZoom:o?16:15,offset:[0,o?-50:0]})}catch(t){console.error("Error fitting map to bounds:",t)}},Pe=a=>a.find(r=>r.type==="station")||null;c.useEffect(()=>(_&&v&&H&&(()=>{if(T.current&&!i.current){if(!v){I("Mapbox key is missing.");return}console.log("Starting map initialization..."),O("Initializing map...");try{L.accessToken=v,i.current=new L.Map({container:T.current,style:"mapbox://styles/mapbox/streets-v12",center:[125.94849837776422,8.483022468128098],zoom:o?11:10.5,attributionControl:!1,interactive:!0,scrollZoom:!0,dragPan:!0,dragRotate:!1,keyboard:!1,doubleClickZoom:!o,touchZoomRotate:!0,touchPitch:!1,failIfMajorPerformanceCaveat:!1,preserveDrawingBuffer:!0});const r=()=>{console.log("Map loaded successfully!"),A(!0),I(null),w.length>0&&oe(w),f&&se(f,{}),N.length>0&&setTimeout(()=>{M()},500),j&&_e(),R()},t=s=>{var l;console.error("Map error:",s),I(`Map error: ${((l=s.error)==null?void 0:l.message)||"Unknown error"}`),A(!0),R()};i.current.once("load",r),i.current.on("error",t);const n=setTimeout(()=>{h||(console.warn("Map load timeout - continuing anyway"),A(!0),R())},1e4);return()=>clearTimeout(n)}catch(r){console.error("Error creating map:",r),I(`Failed to create map: ${r.message}`),A(!0),R()}}})(),()=>{Ue(),i.current&&(console.log("Cleaning up map"),i.current.remove(),i.current=null,A(!1))}),[_,v,H,o]),c.useEffect(()=>{w.length>0&&y&&v&&h&&(console.log("All data available, calculating optimal route..."),xe(w,y,j))},[w,y,v,h]),c.useEffect(()=>{if(j&&f&&k.length>0){const a=setTimeout(()=>{V()},1e3);return()=>clearTimeout(a)}},[f,j]),c.useEffect(()=>{i.current&&N.length>0&&h&&M()},[N,h]),c.useEffect(()=>{h&&w.length>0&&(console.log("Force updating site markers due to state change"),oe(w))},[h,w,o,j,F]),c.useEffect(()=>{h&&f&&(console.log("Force updating driver marker"),se(f,{}))},[h,f,o]),c.useEffect(()=>{if(!S)return;const a=async()=>{try{console.log("Initializing Reverb connection for real-time location updates..."),Ye();const n=ye();if(!n)throw new Error("Echo not initialized");n.channel(`driver-locations.${S}`).listen("DriverLocationUpdated",s=>{console.log("Real-time driver location update received:",s),Y("connected"),re(s)}),n.channel(`schedule-updates.${S}`).listen("ScheduleStatusUpdated",s=>{console.log("Schedule update received:",s),qe(s.schedule)}),n.channel(`site-completion.${S}`).listen("SiteCompletionUpdated",s=>{console.log("Site completion received:",s),He(s)}),Y("connected"),await Ie(),r()}catch(n){console.error("Realtime connection failed:",n),Y("disconnected"),r()}},r=()=>{const n=setInterval(()=>{t()},1e4);return()=>clearInterval(n)},t=async()=>{try{if(E){const n=await W.get(`/schedule/${E}/driver-location`);n.data.success&&n.data.data&&re(n.data.data)}}catch(n){console.error("Error polling driver location:",n)}};return a(),()=>{const n=ye();n&&(n.leave(`driver-locations.${S}`),n.leave(`schedule-updates.${S}`),n.leave(`site-completion.${S}`))}},[S,E]);const Ie=async()=>{try{de(!0),O("Loading collection sites...");const a=await W.get(`/barangay/${S}/current-schedule`);if(a.data.success){const r=a.data.data;if(ie(r),r.id){const t=await W.get(`/schedule/${r.id}/sites`);if(t.data.success){const n=t.data.data;ce(n);const s=Pe(n);s&&(Re(s),console.log("Station found:",s.site_name))}}if(E){const t=await W.get(`/schedule/${E}/driver-location`);t.data.success&&t.data.data&&re(t.data.data)}}R()}catch(a){console.error("Error loading initial data:",a),R()}finally{de(!1)}},re=a=>{if(!a.longitude||!a.latitude){console.warn("Invalid location data received:",a);return}const r=[parseFloat(a.longitude),parseFloat(a.latitude)];console.log("Updating driver location on map:",r),je(r),h&&i.current&&(se(r,a),ze()||i.current.flyTo({center:r,zoom:o?16:15,duration:2e3,essential:!0,offset:[0,o?-100:0]}),j&&V())},He=a=>{console.log("🎯 Handling site completion:",a),ce(r=>r.map(t=>t.id===a.site_id||t.id===a.siteId?(console.log(`✅ Marking site ${t.site_name} as completed`),{...t,status:"completed",collectionStatus:"finished",completed_at:a.completed_at||new Date().toISOString()}):t)),Oe(a.site_name||"Collection Site",a),h&&setTimeout(()=>{const r=w.map(t=>t.id===a.site_id||t.id===a.siteId?{...t,status:"completed",collectionStatus:"finished",completed_at:a.completed_at||new Date().toISOString()}:t);oe(r),j&&f&&V()},100)},Oe=(a,r)=>{const t=document.createElement("div");t.className="fixed top-4 right-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-5 rounded-xl shadow-2xl z-[9999] min-w-[320px] max-w-[420px] transform transition-all duration-500",t.style.animation="slideInRight 0.5s ease-out";const n=r.completed_sites||0,s=r.total_sites||0,l=s>0?Math.round(n/s*100):0;t.innerHTML=`
    ...
    `,document.body.appendChild(t);try{const m=new Audio("data:audio/wav;base64,...");m.volume=.3,m.play().catch(()=>{})}catch{}if(setTimeout(()=>{document.body.contains(t)&&(t.style.opacity="0",t.style.transform="translateX(100%)",setTimeout(()=>{document.body.contains(t)&&document.body.removeChild(t)},300))},6e3),!document.getElementById("resident-completion-animations")){const m=document.createElement("style");m.id="resident-completion-animations",m.textContent=`
      ...
      `,document.head.appendChild(m)}},se=(a,r)=>{if(!i.current||!h)return;le&&le.remove();const t=o?"w-12 h-12":"w-10 h-10",n=o?"w-6 h-6":"w-5 h-5",s=document.createElement("div");s.className="driver-location-marker";const m=(r.timestamp?(new Date-new Date(r.timestamp))/1e3:0)<30;s.innerHTML=`
      <div class="relative">
    ...
    `;try{const p=new L.Marker({element:s,draggable:!1}).setLngLat(a).addTo(i.current),g=new L.Popup({offset:25,closeButton:!1,className:`custom-popup ${o?"max-w-xs":"max-w-sm"}`}).setHTML(`
      ...
      `);p.setPopup(g),Se(p)}catch(p){console.error("Error creating driver marker:",p)}},qe=a=>{ie(a)},oe=a=>{if(!i.current||!h)return;Q.forEach(t=>{t&&t.remove&&t.remove()});const r=a.map((t,n)=>{if(!t.longitude||!t.latitude)return null;try{const s=document.createElement("div");s.className="site-marker";const l=t.status==="completed"||t.collectionStatus==="finished",m=t.status==="in_progress",p=t.type==="station",g=t.purok_name||t.site_name||"Site",u=j&&F&&F.id===t.id&&!l;l&&console.log(`✓ Rendering completed site: ${t.site_name} (ID: ${t.id})`);const x=()=>p?"#DC2626":l||u?"#10B981":"#6B7280",$=()=>p?`
            ...
            `,z=o?"w-14 h-14":"w-12 h-12",Z=o?"w-7 h-7":"w-6 h-6",ne=o?"w-8 h-8":"w-7 h-7",we=k.findIndex(Qe=>Qe.id===t.id)+1,Ze=we>0;s.innerHTML=`
          <div class="relative ${m||u?"animate-pulse":""}">
            ...
            `:""}
            ${p?`
              <div class="${z} rounded-full bg-white shadow-2xl border-4 border-red-600 flex items-center justify-center">
                <div class="${ne} text-red-600">
                  ${$()}
                </div>
              </div>
            `:`
        ...
        `;const We=[parseFloat(t.longitude),parseFloat(t.latitude)],Je=new L.Popup({offset:25,closeButton:!1,className:`custom-popup ${o?"max-w-xs":"max-w-sm"}`}).setHTML(`
          <div class="text-sm ${o?"p-2":"p-3"}">
