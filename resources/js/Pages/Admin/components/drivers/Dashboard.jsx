          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4 sm:mb-6 gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button 
                  className="flex items-center bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 shadow-sm text-sm font-medium py-2 px-2 sm:px-3 rounded-md transition-colors whitespace-nowrap flex-shrink-0"
                >
                  <MdOutlineDateRange className="text-lg mr-1 sm:mr-2"/>
