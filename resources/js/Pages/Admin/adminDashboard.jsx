                        ...
                        <ul className="divide-y divide-gray-200">
                            ...
                            <li className="py-3">
                                <div className="flex space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900">Positive feedback from Oak Avenue</p>
                                        <p className="text-sm text-gray-500">Sarah Wilson • 1 hour ago</p>
                                    </div>
                                </div>
                            </li>
                            <li className="py-3">
                                <div className="flex space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900">Delayed collection at Pine Road</p>
                                        <p className="text-sm text-gray-500">Tom Brown • 2 hours ago</p>
                                    </div>
                                </div>
                            </li>
                            <li className="py-3">
                                <div className="flex space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900">Vehicle maintenance required</p>
                                        <p className="text-sm text-gray-500">System • 3 hours ago</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
